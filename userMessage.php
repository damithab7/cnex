...
<body>
   ...
   <div class="container-fluid">
      <div class="row">
         ...
         <div class="col-12 py-5 px-4 m140">
                              ...
                              <div class="tab-content" id="myTabContent">
                                 <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                    <div class="message_box" id="message_box">
                                       ...
                                       ?>
                                             <div class="list-group rounded-0" onclick="viewMessagesUser('<?php echo $msg_data['from']; ?>');">
                     ...
                     <div class="px-4">
                        <div class="col-12">
                           ...
                           <div class="input-group input-chat-group mb-3">
                              ...
                              <button class="btn-edit btn-purple-v2 input-chat-send" id="send_btn" onclick="send_msg_user();" onkeyup="send_a_msg();"><i class="bi bi-send-fill"></i></button>
