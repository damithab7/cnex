                  ...
                  <div class="col-11 mt-4 mb-3 border border-opacity-50 rounded-3 p-3">
                     <div class="row justify-content-center">
                        ...
                        <div class="col-12 mb-4">
                           <div class="row justify-content-center">
                              ...
                              <div class="col-12 mt-3 mb-3">
                                 <select class="form-select mt-3 mb-3 ViewSelect select-edit select_edit_p" id="productViewC" multiple onchange="loadCollectionAdmin();">
                                    ...
                                    ?>
                                       <div class="col-2">
                                          <div class="form-check">
                                             <input class="form-check-input" type="radio" name="pStatus" id="<?php echo ($status_name); ?>AP">
                                             <label class="form-check-label <?php if ($status_data["id"] == 1) { ?>fw-semibold<?php } ?>" for="<?php echo ($status_name); ?>AP">
                        ...
                        <div class="col-12 col-lg-4 d-grid mt-3 mb-3">
                           <button class="btn-edit btn-purple-v2" onclick="addProductAdmin(<?php echo $size_rs->num_rows;?>);">Save Product</button>
                        </div>
