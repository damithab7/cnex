...
<body>
   ...
   if (isset($_GET["pid"]) && isset($_SESSION["au"])) {
      $pid = $_GET["pid"];
   } else {
                  ...
                  <div class="col-11 mt-4 mb-3 border border-opacity-50 rounded-3 p-3">
                     <div class="row justify-content-center">
                           ...
                           <div class="row justify-content-center">
                              ...
                              <div class="col-12" id="qtyDiv">
                                 <div class="row justify-content-center align-items-start">
                                    ...
                                    ?>
                                          <div class="input-group mt-3 mb-1 control-qty-p suidp" id="sizeQTY<?php echo $phs_data['id']; ?>">
                                             <span id="psqtyspan<?php echo $phs_data['id']; ?>"><?php echo $phs_data["name"]; ?></span>
                                             <input type="number" class="form-control control-edit contorl-edit-admin" value="<?php echo $phs_data["qty"]; ?>" min="1" id="psqty<?php echo $phs_data['id']; ?>" onchange="qtyValueCheckAdmin(<?php echo $phs_data['id']; ?>);" />
                                       ...
                                       ?>
                                          <div class="input-group mt-3 mb-1 control-qty-p d-none" id="sizeQTY<?php echo $size_data1['id']; ?>">
                                             ...
                                             <input type="number" class="form-control control-edit contorl-edit-admin" value="0" min="1" id="psqty<?php echo $size_data1['id']; ?>" onchange="qtyValueCheckAdmin(<?php echo $size_data1['id']; ?>);" />
                        ...
                        <div class="col-11">
                           <div class="row ">
                              <div class="col-12">
                                 <span class="newProductL">Product Status</span>
                              </div>
                              <?php
                              ...
                              <div class="col-12 mt-3 mb-3">
                                 <div class="row justify-content-center">
                                    <?php
                                    for ($s = 0; $s < $status_rs->num_rows; $s++) {
                                       $status_data = $status_rs->fetch_assoc();
                                       $status_name = ucfirst($status_data["name"]);
                                    ?>
                                       <div class="col-2">
                                          <div class="form-check">
                                             <input class="form-check-input" type="radio" name="pStatus" id="<?php echo ($status_name); ?>UP" <?php if ($status_data["id"] == $product_data["status_id"]) { ?>checked<?php } ?>>
                                             <label class="form-check-label <?php if ($status_data["id"] == 1) { ?>fw-semibold<?php } ?>" for="<?php echo ($status_name); ?>UP">
                        ...
                        <div class="col-lg-8 col-12">
                           <div class="row justify-content-center">
                              ...
                              <div class="col-12 col-lg-6 d-grid mt-3">
                                 ...
                                 <label for="productImageUploader" class="col-12 btn-edit" onclick="changeProductImages();">Upload Images</label>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="col-12 col-lg-4 d-grid mt-3 mb-3">
                           <button class="btn-edit btn-purple-v2" onclick="updateProductAdmin(<?php echo ($pid); ?>,<?php echo $images_num; ?>,<?php echo $size_rs->num_rows; ?>);">Save Product</button>
                        </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
               <div class="modal-content bg-black" style="border-radius: 0px;">
                  ...
                  <div class="modal-footer" style="border-top: none;">
                     <button type="button" class="btn-edit btn-purple-v2" id="pauclose" data-bs-dismiss="modal">Close</button>
                  </div>
