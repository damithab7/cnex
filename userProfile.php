   ...
   <head>
      ...
      <title>CneX | <?php echo $user_data["fname"]; ?></title>
                     ...
                     <div class="row justify-content-center">
                        ...
                        <div class="col-12 profile-div mb-2">
                           <div class="row align-items-center justify-content-center">
                              <div class="profile-pro selectDisable">
                                 <img class="img-fluid mt-3 mb-3" src="style/resources/avatar.svg" alt="Avatar here!" width="170px" />
                              </div>
                              <div class="col-12 col-lg-5 text-lg-start text-center mb-3">
                                    ...
                                    <div class="col-12" id="accountDiv">
                                       <div class="row g-3 justify-content-center">
                                          ...
                                          <div class="col-lg-5 col-12 d-grid mb-3">
                                             <button class="btn-purple" onclick="changeProfileAccount();">Save Changes</button>
                                          </div>
                                       </div>
                                    </div>
                                    ...
                                    <div class="col-12 d-none" id="addressDiv">
                                       <div class="row g-3 justify-content-center">
                                          ...
                                          <div class="col-lg-5 col-12 d-grid mb-3 mb-3">
                                             <button class="btn-purple" onclick="saveAddresss();">Save Changes</button>
                                          </div>
                                       </div>
                                    </div>
                                    ...
                                    <div class="col-12 d-none" id="profileSecurity">
                                       <div class="row gap-3 justify-content-center">
                                          ...
                                          <div class="col-lg-4 col-6 d-grid mb-4">
                                             <button class="btn-purple" onclick="changePassword();">change</button>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
